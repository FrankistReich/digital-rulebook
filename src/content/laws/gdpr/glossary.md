...
| subject-matter | 调整对象 | Art. 1 标题 "Subject-matter and objectives" → "调整对象与目标"。**首选"调整对象"**——中国法学界对法律文本"调整对象"的标准译法（指法律所规范的事项）。**不译"主题"**——后者偏文学语体，弱化法律技术含义 |
...
### v1.4 修订（2026-04-28 深夜，Frank 文体修订）

由于 v1.0 baseline 时期 Art. 1 中文行文偏文学化，与法律语体有距离，整体重写。

| 位置 | v1.0 / v1.3 译文 | v1.4 译文 | 修订原因 |
|---|---|---|---|
| Art. 1 title | 主题与目标 | **调整对象与目标** | "Subject-matter" 在法律语境下指"法律所规范的事项"，中文法学专业译法是"调整对象"，不是"主题" |
| Art. 1 Abs. 1 | "本条例**制定有关**在...保护自然人的规则，以及**有关**个人数据自由流动的规则" | "本条例**规定了关于**在...保护自然人的规则，以及**关于**个人数据自由流动的规则" | "规定了"比"制定"更标准；"关于"统一替换"有关"，与官方法律语体对齐 |
| Art. 1 Abs. 2 | "基本权利**与**自由，尤其是其**个人数据保护权**" | "基本权利**和**自由，尤其是其**个人数据受保护的权利**" | "权利和自由"是中国宪法 / 民法典等正式语体的连接词；"受保护的权利"比"保护权"更接近法律技术表达 |
| Art. 1 Abs. 3 | "**不得以**在...保护自然人**为由**" | "**不得出于与**在...保护自然人**有关的理由**" | 更贴近 EN 原文 "for reasons connected with..."；"出于...有关的理由"是更精确的官方语体 |

新增主表条目：

| 英文 | 中文 | 主表位置 |
|---|---|---|
| subject-matter | 调整对象 | S 段（介于 storage limitation 与 supervisory authority 之间）|
...
v1.4 应用：
- ✓ `articles/1.md` title_zh `主题与目标` → `调整对象与目标`
- ✓ `articles/1.md` Abs. 1 / 2 / 3 中文整体改写为更标准的中国法律语体
- 修订涵盖：制定→规定了；有关→关于；权利与自由→权利和自由；个人数据保护权→个人数据受保护的权利；不得以...为由→不得出于...有关的理由
